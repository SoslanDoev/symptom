...
export default createStore({
  state: {
    symptomsAndDiagnosis: [
      {
        ...
        "diagnosis": "бронхит",
        "help": {
          "about_title": "Что такое бронхит?",
          "about_text": "Бронхит – воспалительное заболевание бронхиального дерева. Отек и большое количество слизи в дыхательных путях на фоне воспаления затрудняют поступление воздуха к легким. В отличие от пневмонии, патологический процесс локализуется в бронхах и не затрагивает альвеолы. Главный симптом заболевания – кашель с выделением мокроты или без нее. ",
          "symp_title": "Лечение бронхита",
          "symp_text": "Терапия воспаления бронхов – комплексная, зависит от особенностей, степени тяжести болезни и сопутствующих факторов, которые усугубляют состояние здоровья человека. Независимо от возраста пациента, пульмонолог порекомендует ему постельный или полупостельный режим, отдых, полноценное, сбалансированное питание, обильное питье, пребывание в комнате с влажным прохладным воздухом."
        }
      },
      {
        "symptoms": [
        ...
        "diagnosis": "ангина",
        "help": {
          "about_title": "Что такое ангина?",
          "about_text": "Ангина, или острый тонзиллит – острое заболевание инфекционной природы, характеризующееся воспалением преимущественно небных, реже – иных миндалин, сопровождающееся ярко выраженным синдромом интоксикации. Возникает внезапно, значительно снижает качество жизни пациента, а при отсутствии корректного лечения приводит к развитию серьезных системных осложнений. Избежать негативных последствий болезни поможет своевременное обращение к врачу за точным диагнозом и рекомендациями по терапии.",
          "symp_title": "Лечение ангины",
          "symp_text": "Основу лечения классической бактериальной (гнойной) ангины и у взрослых, и у детей составляют антибиотики. В начале заболевания врач выбирает препарат широкого спектра действия – воздействующий на максимально возможное число микроорганизмов, которые могли бы вызвать данное заболевание. Впоследствии этот антибиотик с учетом данных бактериологического исследования может быть заменен иным препаратом – тем, к которому наиболее чувствителен данный конкретный микроорганизм. Препарат должен быть использован в рабочих, эффективных дозах полным курсом (в зависимости от особенностей клинического случая – от 7 до 14 дней)."
        }
      },
      {
        "symptoms": [
        ...
        "help": {
          "about_title": "Что такое аппендицит?",
          "about_text": "Аппендицит – это воспаление червеобразного отростка слепой кишки. Орган влияет на эндокринную регуляцию, работу иммунитета и поддержание нормальной микрофлоры кишечника, однако не считается жизненно важным. Воспаление аппендикса прогрессирует быстро и ведет к серьезным последствиям, которые угрожают жизни пациента. При аппендиците объем медицинской помощи, как правило, заключается в удалении отростка. Патологическое состояние развивается одинаково часто у мужчин и женщин всех возрастов. Риск заболеть аппендицитом сохраняется до преклонного возраста. Согласно статистике, аппендицит является наиболее часто встречаемым заболеванием пищеварительного тракта, которое требует хирургического лечения. ",
          "symp_title": "Лечение аппендицита",
          "symp_text": "В 99% случаях операция носит экстренный характер. Острое воспаление червеобразного отростка требует как можно более раннего его удаления. Операции проводят открытым способом (брюшную полость вскрывают с помощью скальпеля) или с использованием лапароскопического оборудования. Если воспалительный процесс нарушил целостность стенки отростка, и развился разлитой перитонит, проводят срединную лапаротомию, удаление отростка, тщательный осмотр брюшной полости, санацию, дренирование. В послеоперационном периоде назначают антибиотики и обезболивающие средства. При хронической форме воспаления (встречается редко) возможно лечение консервативными способами (слабительными, спазмолитическими, антибактериальными препаратами). Червеобразный отросток удаляют позже, в ходе плановой операции."
        }
      },
      {
        "symptoms": [
        ...
        "diagnosis": "отравление",
        "help": {
          "about_title": "Что такое отравление?",
          "about_text": "Пищевое отравление – нарушение нормальной жизнедеятельности организма, возникающее вследствие употребления пораженной инфекцией пищи или других ядовитых веществ. Начинается заболевание достаточно быстро. Уже через 2-4 часа после еды наблюдаются первые симптомы: тошнота, чувство слабости, позднее – обильная рвота, понос. Нередко возникает повышение температуры, головная боль. Особенно чувствительны к пищевым отравлениям дети, лица пожилого возраста и больные желудочно-кишечными заболеваниями. У них отравление нередко протекает в более тяжелой форме. Если у Вас наблюдаются подобные симптомы, советуем записаться на прием к врачу. Своевременная консультация предупредит негативные последствия для вашего здоровья.",
          "symp_title": "Лечение отравления",
          "symp_text": "При возникновении отравления, прежде всего, необходимо определить его причину, поскольку лечение зависит от природы отравления. Наиболее действенным методом является промывание желудка, для чего больному следует пить большое количество жидкости (чистой воды или в виде раствора перманганата или питьевой соды). Периодически следует вызывать рвоту – это поможет вывести токсины из организма.  Следует помнить, что состояние больного может ухудшаться по прошествии 10-12 часов после момента отравления, что может быть связано с наличием побочных осложняющих эффектов. В таком случае необходимо незамедлительно обратиться к врачу."
        } 
      },
      {
        "symptoms": [
      ...
      },
      {
        ...
        "help": {
          "about_title": "Что такое бронхиальная астма?",
          "about_text": "Бронхиальная астма – аллергическое заболевание, характеризующееся повторяющимися приступами удушья вследствие спазма бронхов и отёка их слизистой оболочки или длительным кашлем. Несмотря на четкое определение болезни, достаточно яркие симптомы и большие возможности методов исследования, бронхиальную астму зачастую диагностируют как различные формы бронхита и, как следствие этого, неэффективно и неадекватно лечат курсами антибиотиков и противокашлевых препаратов. Специалисты сети медицинских центров «СМ-Клиника» обладают немалым опытом диагностики бронхиальной астмы и владеют информацией относительно современных подходов в ее лечении. Обратившись к нам, вы попадете в руки профессионалов.",
          "symp_title": "Лечение бронхиальной астмы",
          "symp_text": "Принципы лечения бронхиальной астмы варьируются в зависимости от тяжести течения и периода болезни. В первую очередь, требуется прекращение или уменьшение контакта с аллергенами: воздухоочистители, кондиционеры, увлажнители воздуха, борьба с пылевыми клещами, тараканами, специальные чехлы для постельных принадлежностей, отказ от ковров, содержания домашних животных, гипоаллергенная диета и прочие мероприятия. Медикаментозная терапия определяется степенью тяжести заболевания, назначается с учетом осложнений основного заболевания и наличием сопутствующей патологии."
        } 
      },
      {
        "symptoms": [
        ...
        "diagnosis": "мигрень",
        "help": {
          "about_title": "Что такое мигрень?",
          "about_text": "Мигрень – это вид головной боли, который характеризуется периодически повторяющимися приступами пульсирующей головной боли, нередко с односторонней локализацией и достаточной интенсивностью, что затрудняет повседневную активность человека.",
          "symp_title": "Лечение мигрени",
          "symp_text": "Обратитесь к врачу"
        }  
      },
      {
        "symptoms": [
      ...
      },
      {
        ...
        "diagnosis": "АВ блокады сердца",
        "help": {
          "about_title": "Что такое АВ блокады сердца?",
          "about_text": "частичное или полное прерывание проведения импульса от предсердий к желудочкам. Наиболее частой причиной является идиопатический фиброз или склероз проводящей системы сердца.",
          "symp_title": "Лечение АВ блокады сердца",
          "symp_text": "Обратитесь к врачу"
        } 
      },
      {
        ...
        "diagnosis": "пневмония",
        "help": {
          "about_title": "Что такое пневмония?",
          "about_text": "Пневмония — острое инфекционно-воспалительное заболевание легких, вызванное бактериями, вирусами, простейшими или спорами грибов. Может возникать как самостоятельная патология или осложнять течение иных проблем со здоровьем (гриппа, иммунодефицитов, острых воспалительных процессов любой локализации, новообразований и прочих). Значительно снижает качество жизни человека и при отсутствии своевременно начатой терапии может приводить к ряду серьезных осложнений. Избежать плохого прогноза помогут специалисты медицинского холдинга «СМ-Клиника». В короткий срок они проведут информативное обследование, выставят верный диагноз и назначат терапию, принимая которую вы вскоре почувствуете себя лучше.",
          "symp_title": "Лечение пневмонии",
          "symp_text": "В лечении острой пневмонии врачи-пульмонологи сети медицинских центров «СМ-Клиника» придерживаются индивидуального подхода к каждому пациенту с учетом международных рекомендаций по терапии данной патологии. Срок лечения зависит от типа болезни, тяжести ее течения и других факторов. Пациенты с тяжелыми формами патологии подлежат госпитализации в стационар. Лечение пневмонии у взрослых и детей начинается сразу после постановки диагноза. Основу его составляют антибиотики. Выбирая антибактериальные препараты, специалист оценивает степень тяжести пневмонии, общую бактериальную нагрузку, наличие сопутствующей патологии, противопоказаний к действующему веществу и аллергологический анамнез пациента. В начале терапии пациенту назначают препараты максимально широкого спектра действия с учетом возможного возбудителя болезни. После того, как возбудитель будет верифицирован в лаборатории, возможна коррекция терапии – замена антибактериального препарата на более эффективный в данном случае. «СМ-Клиника» оснащена современным медицинским оборудованием, которое помогает проводить комплексные мероприятия по лечению пневмонии, такие как респираторная поддержка и экстракорпоральная мембранная оксигенация. Пациенту также могут быть назначены жаропонижающие, отхаркивающие средства, иммуномодуляторы, иммуноглобулины, глюкокортикостероиды."
        } 
      },
      {
        "symptoms": [
        ...
        "diagnosis": "инсульт",
        "help": {
          "about_title": "Что такое инсульт?",
          "about_text": "Патологическое состояние, характеризующееся острым нарушением кровоснабжения головного мозга и повреждением тканей органа, называют инсультом. Диагностикой и лечением этого заболевания занимаются неврологи.",
          "symp_title": "Лечение инсульта",
          "symp_text": "Обратитесь к врачу"
        } 
      },
      {
    ...
    sympList: [
      ...
      {
        "title": "боли в мышцах и суставах",
        "active": false
      }, 
      {
        "title": "Тошнота",
      ...
      {
        "title": "Обложенный язык",
        "active": false
      }, 
      {
        "title": "Отсутсвие аппетита",
        "active": false
      }, 
      {
        "title": "Боль в правой нижней части живота",
        "active": false
      }, 
      {
        "title": "Рвота",
      ...
      {
        "title": "Чувство сдавленности в грудной клетке", 
        "active": false
      }, 
      {
        "title": "Насморк", 
